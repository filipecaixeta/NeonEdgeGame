...
/**
   Function Objective: Constructor of the class Celing Enemy.
   param: int x,int y (Position of the enemy).
...
/**
   Function Objective: Put this kind of enemy to attack.
   param: None.
   return: Bool True.
*/
...
/**
   Function Objective: Notify if tile is collided, modifing its state.
   param: int tile,Face face.
   return: void.
*/
...
/**
   Function Objective: Function responsable to ubdate CeilingEnemy GameObject.
   param: float dt.
   return: void
*/
...
/**
   Function Objective: Function responsable to ubdate CeilingEnemy GameObject, but overloades with the world object.
   param: TileMap* world, float dt.
   return: void.
*/
